...
TERMUX_PKG_DEPENDS="coreutils, dpkg, findutils, gpgv, grep, libandroid-glob, libbz2, libc++, libiconv, libgcrypt, libgnutls, liblz4, liblzma, sed, tide-keyring, termux-licenses, xxhash, zlib, zstd"
...
termux_step_post_make_install() {
	{
		echo "# The main tide repository, with free plan cloudflare cache"
		echo "deb https://yanmain.top/tide-main/ stable main"
